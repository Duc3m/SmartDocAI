...
│   ├── data_access/            # Xử lý đọc PDF và Vector Store
│   ├── models/                 # Cấu hình kết nối Ollama và Embeddings
│   ├── ui/                     # Xử lý giao diện Streamlit
│   └── utils/                  # Các hàm hỗ trợ tiện ích
├── data/                       # Thư mục lưu trữ file PDF
├── vector_db/                  # Thư mục lưu trữ Vector DB
├── documentation/              # Thư mục tài liệu liên quan
